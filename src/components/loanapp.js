...
import { hubspotFormId, programLoanInfo, selectAProgram } from '../constants/programInfo';
...
const LoanApp = React.forwardRef((props, ref) => {
	...
	const costOfLiving = false; // set to false of cost of living is not available
	...
	//         ReactGA.event({
	//             category: `Apply Now Button | ${props.schoolName}`,
	//             action: 'click',
	...
	return (
		...
		>
			...
			<div className="px-8 text-sm">
				...
				<p
					className="text-center text-primary cursor-pointer font-bold mt-4"
