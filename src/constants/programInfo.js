...
export const schoolInfo = {
  ...
  APRRange36: "11.20 - 12.36%",
  APRRange60: "12.66 - 13.14%",
  interestOnly: [
    {
...
export const skfURL = "https://bloc.skills.fund" // update with Skills Fund url
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the Designer Track and Part-Time Web Developer Track.",
  },
...
export const programLoanInfo = [
  ...
  {
    name: "Designer Track",
    url: "https://my.skills.fund/application?lenderCode=SFBLDT17",
    loanInfo: {
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKBLWD17", // $13,500 max tuition, no COL alert
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 15000,
      loanTerm36: true,
